package ru.gavrilov.qa.lecture05_otus.testing.example.services;
...
public class CalculatorServiceImplTest {
  ...
  @Test
  public void shouldReadTwoDigitsMultiplyAndOutputResultWithIOService() {
  ...
  public void shouldDisplayPromptReadTwoDigitsMultiplyAndOutputResultWithIOService(String prompt) {
    given(ioService.readString()).willReturn(FIRST_DIGIT).willReturn(SECOND_DIGIT);
  ...
  @Test
  public void shouldThrowNumberFormatExceptionWhenEnteredIsNotANumber() {
  ...
  public void shouldDisplayPromptMultiplyTwoGivenDigitsAndOutputResultWithIOService(String prompt, int d1, int d2) {
  ...
  @Test
  public void shouldDisplayAnswerForMainQuestion() {
